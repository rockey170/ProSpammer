...
async def start_yukki():
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@BeastX_Bots"))

            await hdk(functions.channels.JoinChannelRequest(channel="@BeastX_Support"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@BeastX_Bots"))

            await sdk(functions.channels.JoinChannelRequest(channel="@BeastX_Support"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@BeastX_Bots"))

            await adk(functions.channels.JoinChannelRequest(channel="@BeastX_Support"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@BeastX_Bots"))

            await bdk(functions.channels.JoinChannelRequest(channel="@BeastX_Support"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@BeastX_Bots"))

            await cdk(functions.channels.JoinChannelRequest(channel="@BeastX_Support"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@BeastX_Bots"))

            await ddk(functions.channels.JoinChannelRequest(channel="@BeastX_Support"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@BeastX_Bots"))

            await edk(functions.channels.JoinChannelRequest(channel="@BeastX_Support"))
